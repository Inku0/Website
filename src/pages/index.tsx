  ...
  return (
    <main className={"w-screen h-screen bg-neutral-900"}>
      ...
      <div className={"justify-evenly flex text-center"}>
        ...
        <a className={"text-slate-100 mt-60 rounded-lg w-96 text-center leading-6 bg-neutral-300 text-2xl bg-emerald-500 space-x-4 p-10 "} href={"teisendamine"}>(deprecated) Teisendamine</a>
